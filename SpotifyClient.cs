...
namespace DotSpotifyWebWrapper
{
    public class SpotifyClient
    {
        ...
        public async Task<bool> TryGetTokenForScopes(AuthorizationFlowType flowType, IProgress<string> progressReporter, int pkceVerifierLength = 0, params AccessScopeType[] scopes)
        {
            if (scopes.Length == 0)
                return false;
